...
/**
 * Créer une nouvelle classe pour sauvegarder un nouveau DebsRecord
 * (qui contient pickup_datatime, dropoff_datatime, pickup(GridPoint), dropoff(GridPoint), times)  
 */
